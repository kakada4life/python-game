...
def game_over():
    canvas.delete(ALL)
    canvas.create_text(canvas.winfo_width()/2, canvas.winfo_height()/2,font=('console', 70), text="GAME OVER", fill='orange',tags="game over")
...
lable = Label(window, text = "score:{}".format(score), font = ("consoles",40))
lable.pack()

canvas = Canvas(window, bg=BACKGROUND_COLOUR, height=GAME_HIGHT, width=GAME_WIDTH)
canvas.pack()
